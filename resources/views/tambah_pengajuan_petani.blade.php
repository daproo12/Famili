...
@section('petani')
          <div class="container px-2 mx-auto grid">
            ...
            >
              ...
              <label class="block text-sm">
                <span class="text-gray-700 dark:text-gray-400">Desa Lokasi Lahan</span>
                <input
                  class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
              ...
              <label class="block text-sm">
                <span class="text-gray-700 dark:text-gray-400">Kecamatan Lokasi Lahan</span>
                <input
                  class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                  placeholder="Sumbersari"
                />
              ...
              <div class="form-group py-3">
                <label class="text-sm" for="exampleFormControlFile2">Upload file MOU</label>
                <input type="file" class="form-control-file" id="exampleFormControlFile2">
              </div>
